...
ITargetProvider* ComponentFactory::createProvider(ProviderType providerType, const std::string& param)
{
...
IConfigLoader* ComponentFactory::createLoader(LoaderType loaderType, const std::string& param)
{

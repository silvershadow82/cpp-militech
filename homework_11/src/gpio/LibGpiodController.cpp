...
LibGpiodController::~LibGpiodController()
{
  this->release();
}

bool LibGpiodController::init(const std::string &chip, unsigned startLine, unsigned dropLine)
{
  this->release();
...
void LibGpiodController::setStart(bool high)
{
...
void LibGpiodController::setDrop(bool high)
{
...
void LibGpiodController::release()
{
  if (this->startLineHandle) {

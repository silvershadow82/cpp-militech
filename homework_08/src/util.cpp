...
float util::timeToDistance(float distance, float currentSpeed,
                           float attackSpeed, float acceleration,
                           float accPath) {
...
float util::convergeAngle(float &droneAngle, float targetAngle,
